...
function rst_pagination() {
    echo paginate_links( array(
        'prev_text'    => __('<i class="bi bi-chevron-left"></i>'),
        'next_text'    => __('<i class="bi bi-chevron-right"></i>'),
        'type'         => 'list', // Returns a <ul> for Bootstrap
    ) );
}
function my_theme_comment_callback( $comment, $args, $depth ) {
    // Ensure you have a unique ID for each comment
    $tag = ( 'div' === $args['style'] ) ? 'div' : 'li';
?>
<div>
<div id="comment-<?php comment_ID(); ?>" class="comment">
    <div class="d-flex">
        <div class="comment-img flex-shrink-0"><img src="<?php echo get_avatar_url( $comment, array('size' => 60) ); ?>" alt=""></div>
        <div>
            <h5><?php comment_author(); ?> <?php comment_reply_link(array_merge($args, array('reply_text' => '<i class="bi bi-reply-fill"></i> Reply', 'depth' => $depth, 'max_depth' => $args['max_depth']))); ?></h5>
            <time datetime="2020-01-01">01 Jan,2022</time>
            <?php comment_text(); // Display the actual comment text ?>
        </div>
    </div>
</div><!-- End comment #1 -->
<?php
    // Note: WordPress handles the closing </li> or </div> tag automatically
}
function rst_comment_form( $args = array(), $post = null ) {
	$post = get_post( $post );
	...
	$defaults = array(
		...
		'title_reply_before'   => '<h4 id="reply-title">',
